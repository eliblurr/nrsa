    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_title', models.CharField(blank=True, help_text='Title to display in hero, if null page.title will be used', max_length=250)),
                ('hero_sub_title', models.CharField(blank=True, help_text='Subtitle to display in hero, if null no subtitle will be rendered', max_length=250)),
                ('hero_description', models.CharField(blank=True, help_text='Description to display in hero, if null no description will be rendered', max_length=250)),
                ('hero_external_link', models.URLField(blank=True, help_text='Link that points to external resource', max_length=10000, null=True)),
                ('hero_cta', models.CharField(blank=True, default='CTA', help_text='Text to display on Call to Action', max_length=255, null=True, verbose_name='Hero CTA')),
                ('hero_external', models.CharField(blank=True, default='CTA', help_text='Text to display on external link CTA', max_length=255, null=True, verbose_name='Hero External Link')),
                ('body', wagtail.core.fields.RichTextField(blank=True)),
                ('headline', models.CharField(max_length=250)),
                ('description', models.CharField(blank=True, max_length=5000, null=True)),
                ('director_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image')),
                ...
                ('region', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='regional_profiles.regions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news_and_events.newspage')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='news', to='regional_profiles.regionalprofilepage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news_and_events.eventpage')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='regional_profiles.regionalprofilepage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='ActivityOrderable',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activity.activitypage')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='regional_profiles.regionalprofilepage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
